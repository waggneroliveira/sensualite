...
<head>
	...
	<title>Love Prive - Dashboard</title>
...
<body oncontextmenu="return false;">
        ...
        <div class="geex-sidebar">
			...
			<div class="geex-sidebar__wrapper">
				<div class="geex-sidebar__header">
					<a href="{{ route('admin.dashboard.companion.index') }}" class="geex-sidebar__logo">
				...
				<nav class="geex-sidebar__menu-wrapper">
					<ul class="geex-sidebar__menu">
						<li class="geex-sidebar__menu__item mb-2">
							<a href="{{ route('admin.dashboard.companion.index') }}" class="geex-sidebar__menu__link justify-content-start">
								<i class="uil-home"></i>
								<span>Dashboard</span>
							</a>
						</li>
                        ...
                        <li class="geex-sidebar__menu__item mb-2">
                            @if ($hasActiveSubscription || $isCourtesy == 1)
                                <a href="{{ route('admin.dashboard.companion.gallery.index') }}" class="geex-sidebar__menu__link justify-content-start">
                            @else
                                <div class="geex-sidebar__menu__link justify-content-start" style="pointer-events: none; opacity: 0.5; cursor: not-allowed;">
                            @endif
                        ...
                        <li class="geex-sidebar__menu__item mb-2">
                            @if ($hasActiveSubscription || $isCourtesy == 1)
                                <a href="{{ route('admin.dashboard.companion.post.index') }}" class="geex-sidebar__menu__link justify-content-start">
                            @else
                                <div class="geex-sidebar__menu__link justify-content-start" style="pointer-events: none; opacity: 0.5; cursor: not-allowed;">
                            @endif
                        ...
                        <li class="geex-sidebar__menu__item mb-2">
                            <a href="{{route('admin.dashboard.companion.plan')}}" class="geex-sidebar__menu__link justify-content-start">
                        ...
                        <li class="geex-sidebar__menu__item mb-2">
                            @if ($hasActiveSubscription || $isCourtesy == 1)
                                <a href="{{ route('admin.dashboard.companion.profile.index') }}" class="geex-sidebar__menu__link justify-content-start">
                            @else
                                <div class="geex-sidebar__menu__link justify-content-start" style="pointer-events: none; opacity: 0.5; cursor: not-allowed;">
                            @endif
                                    <i class="uil-user"></i>
                        ...
                        <li class="geex-sidebar__menu__item mb-2">
                            @if ($hasActiveSubscription || $isCourtesy == 1)
                                <a href="{{ route('admin.dashboard.feedback.index') }}" class="geex-sidebar__menu__link justify-content-start">
                            @else
                                <div class="geex-sidebar__menu__link justify-content-start" style="pointer-events: none; opacity: 0.5; cursor: not-allowed;">
                            @endif
                                    <i class="uil-chat"></i>
    ...
    {{-- Evitar atalho de ispecionar elemento --}}
    <script>
        document.addEventListener('keydown', function(e) {
            const key = e.key.toLowerCase();

            // Bloquear F12, Ctrl+Shift+I, Ctrl+Shift+J, Ctrl+S, Ctrl+P
            if (
                key === 'f12' ||
                (e.ctrlKey && e.shiftKey && (key === 'i' || key === 'j')) ||
                (e.ctrlKey && (key === 's' || key === 'p'))
            ) {
                e.preventDefault();
                return false;
            }

            // Redirecionar ao tentar ver o código-fonte (Ctrl+U)
            if (e.ctrlKey && key === 'u') {
        ...
        // Também tenta bloquear clique com botão direito
