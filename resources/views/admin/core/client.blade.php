				...
				<nav class="geex-sidebar__menu-wrapper">
					<ul class="geex-sidebar__menu">
						<li class="geex-sidebar__menu__item mb-2">
							<a href="{{ route('admin.dashboard.client.index') }}" class="geex-sidebar__menu__link justify-content-start">
								<i class="uil-home"></i>
								<span>Dashboard</span>
							</a>
						</li>
                        ...
                        <li class="geex-sidebar__menu__item mb-2">
                            <a href="{{route('admin.dashboard.client.edit', Auth::guard('cliente')->user()->id)}}" class="geex-sidebar__menu__link justify-content-start">
                                <i class="uil-user"></i>
                                <span>Perfil</span>
                            </a>
                        </li>
