    ...
    <div class="geex-content__authentication">
        <div class="geex-content__authentication__content">
            <div class="geex-content__authentication__content__wrapper">
                ...
                <form action="{{route('admin.client.authenticate')}}" id="signInForm" class="geex-content__authentication__form" method="POST">
                    @csrf
                    <h2 class="geex-content__authentication__title">Área do Cliente 👋</h2>

                    <input type="hidden" name="clientPage" value="false">
                    ...
                    <div class="geex-content__authentication__form-footer">
                        Doesn't have any account? <a href="#">Inscrever-se</a>
                    </div>
                </form>
            </div>
        </div>
