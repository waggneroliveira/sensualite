    ...
    <div class="geex-content__authentication">
        <div class="geex-content__authentication__content">
            <div class="geex-content__authentication__content__wrapper">
                ...
                <form action="{{route('admin.companion.authenticate')}}" id="signInForm" class="geex-content__authentication__form" method="POST">
                    @csrf
                    <h2 class="geex-content__authentication__title">Área do Acompanhante</h2>
